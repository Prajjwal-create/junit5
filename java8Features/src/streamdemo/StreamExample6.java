...
//java program to group Na dPArtition Collectors
/*
...
public class StreamExample6 {
	...
	public static void main(String[] args) {
		...
		System.out.println("******* Musical Instrumnt in collection*******");
		musicalInstruments.stream().forEach(i -> System.out.println(i.getName()+" "+i.getType()+" "+i.getPrice()));
		

		System.out.println("Group Instrument by Type");
		...
		System.out.println("************ Partition Instrument by price******");
